...
var maxDigits, ZERO_ARRAY, bigZero, bigOne, dpl10, lr10, hexatrigesimalToChar, hexToChar,
    highBitMasks, lowBitMasks, biRadixBase = 2,
    biRadixBits = 16,
...
setMaxDigits(20), dpl10 = 15, lr10 = biFromNumber(1e15),
...
function encryptedString(a, b) {
    for (var f, g, h, i, j, k, l, c = [], d = b.length, e = 0; d > e;) c[e] = b.charCodeAt(e), e++;
...
function biDivideModulo(a, b) {
    ...
    return g = biShiftRight(g, i), f.isNeg = a.isNeg != e, a.isNeg && (f = e ? biAdd(f, bigOne) : biSubtract(f, bigOne), b = biShiftRight(b, i), g = biSubtract(b, g)), 0 == g.digits[0] && 0 == biHighIndex(g) && (g.isNeg = !1), [f, g]
}
